...
_GLOVE_PATH = 'D:/Yahia/AI/Test/glove.6B.50d.txt'  # Updated path for GloVe word embeddings.
...
def main(*args, use_dummy_data: bool = False, **kwargs) -> None:
  ...
  if not use_dummy_data:
    if not os.path.exists(_GLOVE_PATH):
      raise FileNotFoundError(f"GloVe embeddings not found at {_GLOVE_PATH}. Please download 'glove.6B.50d.txt' from https://nlp.stanford.edu/data/glove.6B.zip and place it at this path.")
  ...
  print("\n==== RESULTS: TRAINING (NNGP) ====")
  fx_train_nngp, fx_train_ntk = predict(x_test=x_train, get=("nngp", "ntk"))
  util.print_summary('NNGP train', y_train, fx_train_nngp, None, loss)
  print("==== END OF TRAINING (NNGP) RESULTS ====")

  print("\n==== RESULTS: NNGP ====")
  util.print_summary('NNGP test', y_test, fx_test_nngp, None, loss)
  print("==== END OF NNGP RESULTS ====")
  print("\n==== RESULTS: NTK ====")
  util.print_summary('NTK test', y_test, fx_test_ntk, None, loss)
  print("==== END OF NTK RESULTS ====")
...
if __name__ == '__main__':
  app.run(lambda *a, **k: main(*a, use_dummy_data=True, **k))
